...
| **Member 2: AshenAloka**<br/>`IT24102592@my.sliit.lk`<br/>*(Security Lead: SQLi & Threat Modeling)* | STRIDE Threat Model, 3x3 Risk Register, SQL Injection Exploit & Remediation | `docs/threat-model`<br/>`feature/sql-injection-fix` | - `docs/threat-model/stride.md`<br/>- `docs/risk-assessment/risk-register.md`<br/>- `app/vulnerabilities/sqli/source/low.php`<br/>- `evidence/02-sqli-before/`, `evidence/03-sqli-after/` |
